...
public final class FMFontFamilyInstanceIterator extends StructObject {
	static {
		NatJ.register();
	}
	...
	@Generated
	public FMFontFamilyInstanceIterator() {
		super(FMFontFamilyInstanceIterator.class);
	}

	@Generated
	protected FMFontFamilyInstanceIterator(Pointer peer) {
		super(peer);
	}
