...
public class NSCloneCommand extends NSScriptCommand {
	...
	@Generated
	protected NSCloneCommand(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native NSCloneCommand alloc();

	@Generated
	@Selector("init")
	public native NSCloneCommand init();

	@Generated
	@Selector("initWithCommandDescription:")
	public native NSCloneCommand initWithCommandDescription(
