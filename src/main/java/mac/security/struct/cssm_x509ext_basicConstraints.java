...
@Generated
@Structure()
public final class cssm_x509ext_basicConstraints extends StructObject {
	static {
		NatJ.register();
	}
	...
	@Generated
	public cssm_x509ext_basicConstraints() {
		super(cssm_x509ext_basicConstraints.class);
	}

	@Generated
	protected cssm_x509ext_basicConstraints(Pointer peer) {
		super(peer);
	}

	@Generated
	public cssm_x509ext_basicConstraints(int cA, int pathLenConstraintPresent,
