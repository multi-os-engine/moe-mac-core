...
public final class ExtendedFileInfo extends StructObject {
	static {
		NatJ.register();
	}
	...
	public ExtendedFileInfo() {
		super(ExtendedFileInfo.class);
	}

	@Generated
	protected ExtendedFileInfo(Pointer peer) {
		super(peer);
	}

	@Generated
	@StructureField(order = 0, isGetter = true, count = 4)
	public native short reserved1(int field_idx);

	@Generated
	@StructureField(order = 0, isGetter = false, count = 4)
	public native void setReserved1(short value, int field_idx);
