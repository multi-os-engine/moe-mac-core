...
public final class AERemoteProcessResolverContext extends StructObject {
	static {
		NatJ.register();
	}
	...
	public AERemoteProcessResolverContext() {
		super(AERemoteProcessResolverContext.class);
	}

	@Generated
	protected AERemoteProcessResolverContext(Pointer peer) {
		super(peer);
	}
