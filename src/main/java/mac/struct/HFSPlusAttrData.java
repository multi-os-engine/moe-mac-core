...
public final class HFSPlusAttrData extends StructObject {
	static {
		NatJ.register();
	}
	...
	@Generated
	public HFSPlusAttrData() {
		super(HFSPlusAttrData.class);
	}

	@Generated
	protected HFSPlusAttrData(Pointer peer) {
		super(peer);
	}
	...
	public native int attrSize();

	@Generated
	@StructureField(order = 2, isGetter = false)
	public native void setAttrSize(int value);

	@Generated
	@StructureField(order = 3, isGetter = true, count = 2)
	public native byte attrData(int field_idx);

	@Generated
	@StructureField(order = 3, isGetter = false, count = 2)
	public native void setAttrData(byte value, int field_idx);
}
