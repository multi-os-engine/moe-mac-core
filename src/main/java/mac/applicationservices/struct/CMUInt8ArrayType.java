...
public final class CMUInt8ArrayType extends StructObject {
	static {
		NatJ.register();
	}
	...
	@Generated
	public CMUInt8ArrayType() {
		super(CMUInt8ArrayType.class);
	}

	@Generated
	protected CMUInt8ArrayType(Pointer peer) {
		super(peer);
	}

	@Generated
	public CMUInt8ArrayType(int typeDescriptor, int reserved, byte value) {
		super(CMUInt8ArrayType.class);
