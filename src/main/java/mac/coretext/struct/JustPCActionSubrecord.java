...
public final class JustPCActionSubrecord extends StructObject {
	...
	@Generated
	public JustPCActionSubrecord(short theClass, short theType, int length,
			int data) {
		super(JustPCActionSubrecord.class);
	...
	public native short theClass();

	@Generated
	@StructureField(order = 0, isGetter = false)
	public native void setTheClass(short value);

	@Generated
	@StructureField(order = 1, isGetter = true)
	public native short theType();

	@Generated
	@StructureField(order = 1, isGetter = false)
	public native void setTheType(short value);
