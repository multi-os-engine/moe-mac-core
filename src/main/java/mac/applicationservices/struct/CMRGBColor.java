...
@Generated
@Structure()
public final class CMRGBColor extends StructObject {
	static {
		NatJ.register();
	}
	...
	@Generated
	public CMRGBColor() {
		super(CMRGBColor.class);
	}

	@Generated
	protected CMRGBColor(Pointer peer) {
		super(peer);
	}

	@Generated
	public CMRGBColor(short red, short green, short blue) {
		super(CMRGBColor.class);
		setRed(red);
		setGreen(green);
		setBlue(blue);
