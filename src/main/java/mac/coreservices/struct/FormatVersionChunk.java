...
public final class FormatVersionChunk extends StructObject {
	static {
		NatJ.register();
	}
	...
	public FormatVersionChunk() {
		super(FormatVersionChunk.class);
	}

	@Generated
	protected FormatVersionChunk(Pointer peer) {
		super(peer);
	}

	@Generated
	public FormatVersionChunk(int ckID, int ckSize, int timestamp) {
		super(FormatVersionChunk.class);
		setCkID(ckID);
		setCkSize(ckSize);
