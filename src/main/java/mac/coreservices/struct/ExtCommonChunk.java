...
public final class ExtCommonChunk extends StructObject {
	static {
		NatJ.register();
	}
	...
	@Generated
	public ExtCommonChunk() {
		super(ExtCommonChunk.class);
	}

	@Generated
	protected ExtCommonChunk(Pointer peer) {
		super(peer);
	}
	...
	public native int compressionType();

	@Generated
	@StructureField(order = 6, isGetter = false)
	public native void setCompressionType(int value);

	@Generated
	@StructureField(order = 7, isGetter = true)
	public native byte compressionName();

	@Generated
	@StructureField(order = 7, isGetter = false)
	public native void setCompressionName(byte value);
}
