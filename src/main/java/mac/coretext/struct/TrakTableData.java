...
public final class TrakTableData extends StructObject {
	...
	@Generated
	public TrakTableData(short nTracks, short nSizes, int sizeTableOffset,
			@ByValue TrakTableEntry trakTable) {
		super(TrakTableData.class);
		setNTracks(nTracks);
		setNSizes(nSizes);
	...
	public native short nTracks();

	@Generated
	@StructureField(order = 0, isGetter = false)
	public native void setNTracks(short value);

	@Generated
	@StructureField(order = 1, isGetter = true)
	public native short nSizes();

	@Generated
	@StructureField(order = 1, isGetter = false)
	public native void setNSizes(short value);
