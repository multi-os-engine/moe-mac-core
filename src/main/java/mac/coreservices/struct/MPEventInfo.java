...
@Generated
@Structure()
public final class MPEventInfo extends StructObject {
	static {
		NatJ.register();
	}
	...
	@Generated
	public MPEventInfo() {
		super(MPEventInfo.class);
	}

	@Generated
	protected MPEventInfo(Pointer peer) {
		super(peer);
	}
	...
	public native int eventName();

	@Generated
	@StructureField(order = 2, isGetter = false)
	public native void setEventName(int value);
