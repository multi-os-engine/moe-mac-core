...
public class NSDeleteCommand extends NSScriptCommand {
	...
	@Generated
	protected NSDeleteCommand(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native NSDeleteCommand alloc();

	@Generated
	@Selector("init")
	public native NSDeleteCommand init();

	@Generated
	@Selector("initWithCommandDescription:")
	public native NSDeleteCommand initWithCommandDescription(
			NSScriptCommandDescription commandDef);

	@Generated
	@Selector("keySpecifier")
	public native NSScriptObjectSpecifier keySpecifier();
