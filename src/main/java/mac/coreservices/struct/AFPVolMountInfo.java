...
public final class AFPVolMountInfo extends StructObject {
	static {
		NatJ.register();
	}
	...
	@Generated
	public AFPVolMountInfo() {
		super(AFPVolMountInfo.class);
	}

	@Generated
	protected AFPVolMountInfo(Pointer peer) {
		super(peer);
	}
	...
	@Generated
	@StructureField(order = 12, isGetter = true, count = 144)
	public native byte AFPData(int field_idx);

	@Generated
	@StructureField(order = 12, isGetter = false, count = 144)
