...
public final class ATSJustWidthDeltaEntryOverride extends StructObject {
	static {
		NatJ.register();
	}
	...
	public ATSJustWidthDeltaEntryOverride() {
		super(ATSJustWidthDeltaEntryOverride.class);
	}

	@Generated
	protected ATSJustWidthDeltaEntryOverride(Pointer peer) {
		super(peer);
	}
	...
	public native short growFlags();

	@Generated
	@StructureField(order = 4, isGetter = false)
	public native void setGrowFlags(short value);

	@Generated
	@StructureField(order = 5, isGetter = true)
	public native short shrinkFlags();

	@Generated
	@StructureField(order = 5, isGetter = false)
	public native void setShrinkFlags(short value);
}
