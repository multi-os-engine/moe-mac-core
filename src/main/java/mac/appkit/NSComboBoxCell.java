...
public class NSComboBoxCell extends NSTextFieldCell {
	...
	@Generated
	protected NSComboBoxCell(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native NSComboBoxCell alloc();

	@Generated
	@Selector("completedString:")
	public native String completedString(String string);
	...
	@Generated
	@Selector("init")
	public native NSComboBoxCell init();

	@Generated
	@Selector("initImageCell:")
	public native NSComboBoxCell initImageCell(NSImage image);

	@Generated
	@Selector("initTextCell:")
	public native NSComboBoxCell initTextCell(String aString);
