...
public final class FMFontFamilyIterator extends StructObject {
	static {
		NatJ.register();
	}
	...
	@Generated
	public FMFontFamilyIterator() {
		super(FMFontFamilyIterator.class);
	}

	@Generated
	protected FMFontFamilyIterator(Pointer peer) {
		super(peer);
	}
