...
public final class CMParametricCurveType extends StructObject {
	static {
		NatJ.register();
	}
	...
	@Generated
	public CMParametricCurveType() {
		super(CMParametricCurveType.class);
	}

	@Generated
	protected CMParametricCurveType(Pointer peer) {
		super(peer);
	}
	...
	public native short functionType();

	@Generated
	@StructureField(order = 2, isGetter = false)
	public native void setFunctionType(short value);
