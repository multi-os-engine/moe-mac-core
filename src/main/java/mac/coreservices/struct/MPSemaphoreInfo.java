...
@Generated
@Structure()
public final class MPSemaphoreInfo extends StructObject {
	static {
		NatJ.register();
	}
	...
	public MPSemaphoreInfo() {
		super(MPSemaphoreInfo.class);
	}

	@Generated
	protected MPSemaphoreInfo(Pointer peer) {
		super(peer);
	}
	...
	public native int semaphoreName();

	@Generated
	@StructureField(order = 2, isGetter = false)
	public native void setSemaphoreName(int value);
	...
	public native long maximum();

	@Generated
	@StructureField(order = 5, isGetter = false)
	public native void setMaximum(long value);
