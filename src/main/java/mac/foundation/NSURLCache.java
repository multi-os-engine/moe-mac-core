...
public class NSURLCache extends NSObject {
	...
	public native NSURLCache initWithMemoryCapacityDiskCapacityDiskPath(
			long memoryCapacity, long diskCapacity, String path);
	...
	public native void setDiskCapacity(long diskCapacity);

	@Generated
	@Selector("setMemoryCapacity:")
	public native void setMemoryCapacity(long memoryCapacity);
