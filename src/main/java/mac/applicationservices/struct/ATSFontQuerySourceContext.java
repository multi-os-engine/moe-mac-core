...
public final class ATSFontQuerySourceContext extends StructObject {
	static {
		NatJ.register();
	}
	...
	public ATSFontQuerySourceContext() {
		super(ATSFontQuerySourceContext.class);
	}

	@Generated
	protected ATSFontQuerySourceContext(Pointer peer) {
		super(peer);
	}
