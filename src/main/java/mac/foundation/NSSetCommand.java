...
public class NSSetCommand extends NSScriptCommand {
	...
	@Generated
	protected NSSetCommand(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native NSSetCommand alloc();

	@Generated
	@Selector("init")
	public native NSSetCommand init();

	@Generated
	@Selector("initWithCommandDescription:")
	public native NSSetCommand initWithCommandDescription(
