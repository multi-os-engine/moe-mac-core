...
public final class CMProfileSequenceDescType extends StructObject {
	static {
		NatJ.register();
	}
	...
	@Generated
	public CMProfileSequenceDescType() {
		super(CMProfileSequenceDescType.class);
	}

	@Generated
	protected CMProfileSequenceDescType(Pointer peer) {
		super(peer);
	}

	@Generated
	public CMProfileSequenceDescType(int typeDescriptor, int reserved,
			int count, byte data) {
		super(CMProfileSequenceDescType.class);
