...
public class NSEPSImageRep extends NSImageRep {
	...
	@Generated
	protected NSEPSImageRep(Pointer peer) {
		super(peer);
	}

	@Generated
	@Selector("EPSRepresentation")
	public native NSData EPSRepresentation();

	@Generated
	@Owned
	@Selector("alloc")
	public static native NSEPSImageRep alloc();
	...
	public static native NSEPSImageRep imageRepWithContentsOfFile(
			String filename);

	@Generated
	@Selector("imageRepWithContentsOfURL:")
	public static native NSEPSImageRep imageRepWithContentsOfURL(NSURL url);

	@Generated
	@Selector("imageRepWithData:")
	public static native NSEPSImageRep imageRepWithData(NSData epsData);

	@Generated
	@Selector("imageRepWithPasteboard:")
	public static native NSEPSImageRep imageRepWithPasteboard(
	...
	@Generated
	@Selector("init")
	public native NSEPSImageRep init();

	@Generated
	@Selector("initWithData:")
	public native NSEPSImageRep initWithData(NSData epsData);
