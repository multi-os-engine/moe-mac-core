...
public class NSPortNameServer extends NSObject {
	...
	@Generated
	protected NSPortNameServer(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native NSPortNameServer alloc();

	@Generated
	@Selector("init")
	public native NSPortNameServer init();
	...
	public static native NSPortNameServer systemDefaultPortNameServer();
}
