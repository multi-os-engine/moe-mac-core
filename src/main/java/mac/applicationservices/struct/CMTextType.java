...
public final class CMTextType extends StructObject {
	static {
		NatJ.register();
	}
	...
	@Generated
	public CMTextType() {
		super(CMTextType.class);
	}

	@Generated
	protected CMTextType(Pointer peer) {
		super(peer);
	}

	@Generated
	public CMTextType(int typeDescriptor, int reserved, byte text) {
		super(CMTextType.class);
