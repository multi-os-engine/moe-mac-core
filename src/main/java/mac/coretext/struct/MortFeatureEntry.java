...
public final class MortFeatureEntry extends StructObject {
	...
	@Generated
	public MortFeatureEntry(short featureType, short featureSelector,
			int enableFlags, int disableFlags) {
		super(MortFeatureEntry.class);
	...
	public native short featureType();

	@Generated
	@StructureField(order = 0, isGetter = false)
	public native void setFeatureType(short value);

	@Generated
	@StructureField(order = 1, isGetter = true)
	public native short featureSelector();

	@Generated
	@StructureField(order = 1, isGetter = false)
	public native void setFeatureSelector(short value);
