...
@Generated
@Structure()
public final class ICFontRecord extends StructObject {
	static {
		NatJ.register();
	}
	...
	@Generated
	public ICFontRecord() {
		super(ICFontRecord.class);
	}

	@Generated
	protected ICFontRecord(Pointer peer) {
		super(peer);
	}
	...
	public native byte font(int field_idx);

	@Generated
	@StructureField(order = 3, isGetter = false, count = 256)
	public native void setFont(byte value, int field_idx);
}
