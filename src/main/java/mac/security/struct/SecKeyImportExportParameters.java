...
@Generated
@Structure()
public final class SecKeyImportExportParameters extends StructObject {
	static {
		NatJ.register();
	}
	...
	public SecKeyImportExportParameters() {
		super(SecKeyImportExportParameters.class);
	}

	@Generated
	protected SecKeyImportExportParameters(Pointer peer) {
		super(peer);
	}
	...
	public native int keyAttributes();

	@Generated
	@StructureField(order = 7, isGetter = false)
	public native void setKeyAttributes(int value);
}
