...
public final class CMIntentCRDVMSize extends StructObject {
	static {
		NatJ.register();
	}
	...
	@Generated
	public CMIntentCRDVMSize() {
		super(CMIntentCRDVMSize.class);
	}

	@Generated
	protected CMIntentCRDVMSize(Pointer peer) {
		super(peer);
	}

	@Generated
	public CMIntentCRDVMSize(int renderingIntent, int VMSize) {
		super(CMIntentCRDVMSize.class);
