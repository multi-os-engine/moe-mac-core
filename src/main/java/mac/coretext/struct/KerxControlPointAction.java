...
public final class KerxControlPointAction extends StructObject {
	...
	@Generated
	public KerxControlPointAction(short markControlPoint, short currControlPoint) {
		super(KerxControlPointAction.class);
	...
	public native short markControlPoint();

	@Generated
	@StructureField(order = 0, isGetter = false)
	public native void setMarkControlPoint(short value);

	@Generated
	@StructureField(order = 1, isGetter = true)
	public native short currControlPoint();

	@Generated
	@StructureField(order = 1, isGetter = false)
	public native void setCurrControlPoint(short value);
}
