...
public final class CSIdentityClientContext extends StructObject {
	static {
		NatJ.register();
	}
	...
	public CSIdentityClientContext() {
		super(CSIdentityClientContext.class);
	}

	@Generated
	protected CSIdentityClientContext(Pointer peer) {
		super(peer);
	}
	...
	public native void setStatusUpdated(
			@FunctionPtr(name = "call_statusUpdated") Function_statusUpdated value);

	@Runtime(CRuntime.class)
	@Generated
	static public interface Function_statusUpdated {
		@Generated
		public void call_statusUpdated(VoidPtr arg0, long arg1, VoidPtr arg2,
				VoidPtr arg3);
	}
}
