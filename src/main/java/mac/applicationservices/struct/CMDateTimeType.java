...
public final class CMDateTimeType extends StructObject {
	static {
		NatJ.register();
	}
	...
	@Generated
	public CMDateTimeType() {
		super(CMDateTimeType.class);
	}

	@Generated
	protected CMDateTimeType(Pointer peer) {
		super(peer);
	}

	@Generated
	public CMDateTimeType(int typeDescriptor, int reserved,
			@ByValue CMDateTime dateTime) {
		super(CMDateTimeType.class);
