...
EXPORT CFOptionFlags __natj_inline_CFUserNotificationCheckBoxChecked(CFIndex i) {
	return CFUserNotificationCheckBoxChecked(i);
}

EXPORT CFOptionFlags __natj_inline_CFUserNotificationSecureTextField(CFIndex i) {
	return CFUserNotificationSecureTextField(i);
}

EXPORT CFOptionFlags __natj_inline_CFUserNotificationPopUpSelection(CFIndex n) {
	return CFUserNotificationPopUpSelection(n);
}
