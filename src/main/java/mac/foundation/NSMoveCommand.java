...
public class NSMoveCommand extends NSScriptCommand {
	...
	@Generated
	protected NSMoveCommand(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native NSMoveCommand alloc();

	@Generated
	@Selector("init")
	public native NSMoveCommand init();

	@Generated
	@Selector("initWithCommandDescription:")
	public native NSMoveCommand initWithCommandDescription(
