...
public final class JustPCConditionalAddAction extends StructObject {
	...
	@Generated
	public JustPCConditionalAddAction(int substThreshold, short addGlyph,
			short substGlyph) {
		super(JustPCConditionalAddAction.class);
	...
	public native short addGlyph();

	@Generated
	@StructureField(order = 1, isGetter = false)
	public native void setAddGlyph(short value);

	@Generated
	@StructureField(order = 2, isGetter = true)
	public native short substGlyph();

	@Generated
	@StructureField(order = 2, isGetter = false)
	public native void setSubstGlyph(short value);
}
