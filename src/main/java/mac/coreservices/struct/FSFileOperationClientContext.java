...
public final class FSFileOperationClientContext extends StructObject {
	static {
		NatJ.register();
	}
	...
	public FSFileOperationClientContext() {
		super(FSFileOperationClientContext.class);
	}

	@Generated
	protected FSFileOperationClientContext(Pointer peer) {
		super(peer);
	}
