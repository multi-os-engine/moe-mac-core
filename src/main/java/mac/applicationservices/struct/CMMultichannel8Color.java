...
@Generated
@Structure()
public final class CMMultichannel8Color extends StructObject {
	static {
		NatJ.register();
	}
	...
	@Generated
	public CMMultichannel8Color() {
		super(CMMultichannel8Color.class);
	}

	@Generated
	protected CMMultichannel8Color(Pointer peer) {
		super(peer);
	}
