...
public final class FndrExtendedFileInfo extends StructObject {
	static {
		NatJ.register();
	}
	...
	@Generated
	public FndrExtendedFileInfo() {
		super(FndrExtendedFileInfo.class);
	}

	@Generated
	protected FndrExtendedFileInfo(Pointer peer) {
		super(peer);
	}
