...
public final class STHeader extends StructObject {
	...
	public native short classTableOffset();

	@Generated
	@StructureField(order = 2, isGetter = false)
	public native void setClassTableOffset(short value);

	@Generated
	@StructureField(order = 3, isGetter = true)
	public native short stateArrayOffset();

	@Generated
	@StructureField(order = 3, isGetter = false)
	public native void setStateArrayOffset(short value);

	@Generated
	@StructureField(order = 4, isGetter = true)
	public native short entryTableOffset();

	@Generated
	@StructureField(order = 4, isGetter = false)
	public native void setEntryTableOffset(short value);
}
