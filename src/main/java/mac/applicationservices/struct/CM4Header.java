...
public final class CM4Header extends StructObject {
	static {
		NatJ.register();
	}
	...
	@Generated
	public CM4Header() {
		super(CM4Header.class);
	}

	@Generated
	protected CM4Header(Pointer peer) {
		super(peer);
	}
	...
	@Generated
	@StructureField(order = 16, isGetter = true, count = 16)
	public native byte digest(int field_idx);

	@Generated
	@StructureField(order = 16, isGetter = false, count = 16)
	public native void setDigest(byte value, int field_idx);

	@Generated
	@StructureField(order = 17, isGetter = true, count = 28)
	public native byte reserved(int field_idx);

	@Generated
	@StructureField(order = 17, isGetter = false, count = 28)
