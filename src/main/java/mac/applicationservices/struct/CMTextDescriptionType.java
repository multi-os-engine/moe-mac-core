...
public final class CMTextDescriptionType extends StructObject {
	static {
		NatJ.register();
	}
	...
	@Generated
	public CMTextDescriptionType() {
		super(CMTextDescriptionType.class);
	}

	@Generated
	protected CMTextDescriptionType(Pointer peer) {
		super(peer);
	}
	...
	public native int ASCIICount();

	@Generated
	@StructureField(order = 2, isGetter = false)
	public native void setASCIICount(int value);
